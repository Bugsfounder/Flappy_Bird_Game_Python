...
import sys  # WE WILL USE sys.exit() FOR EXIT THE PROGRAM
import pygame
from pygame import transform
from pygame.locals import *  # BASIC PYGAME IMPORTS

# GLOBAL VARIABLES FOR THE GAME
FPS = 32  # FRAMES PER SECOND (HOW MANY FRAMES ARE RANDER PER SECOND)
SCREENWIDTH = 289
SCREENHEIGHT = 511
...
def mainGame():
    ...
    while True:
        ...
        # This function will return if you are crashed
        ...
        # ADD A NEW PIPE WHEN THE FIRST IS ABOUT TO CROSS TO THE LEFT OF THE PART OF THE SCREEN
...
if __name__ == '__main__':
    # THIS WILL BE THE MAIN POINT FROM WHERE OUR GAME WILL STARTS
    pygame.init()  # INITIALIZE ALL PYGAME's MODULES
    FPSCLOCK = pygame.time.Clock()
    pygame.display.set_caption("Flappy Bird By Manisha")
